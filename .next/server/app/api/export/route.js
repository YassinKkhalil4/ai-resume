...
startxref
${600+t.length}
%%EOF`;return Buffer.from(n,"utf8")}var w=n(32064),b=n(74068),S=n(57033);let $="nodejs",_="force-dynamic",k=30;async function j(e){return a.NextResponse.json({error:"Method not allowed",message:"This endpoint only accepts POST requests",method:e.method},{status:405})}async function D(e){let t,n;console.log("Export API called:",{method:e.method,url:e.url,timestamp:new Date().toISOString()});try{let t=(0,w.d7)(e);if(!t.ok)return console.log("Guard check failed:",t.res),t.res;if((0,b.iE)().pauseExport)return a.NextResponse.json({code:"export_paused",message:"Export functionality is temporarily disabled"},{status:503});console.log("Guard check passed");let n=(0,S.db)({route:"export"});if(console.log("Trace started"),!(e.headers.get("content-type")||"").includes("application/json"))return a.NextResponse.json({code:"invalid_content_type",message:"Request must be JSON format"},{status:415});let{session_id:i,template:o="minimal",format:r="pdf",options:s={includeSummary:!0,includeSkills:!0},session_snapshot:c}=await e.json()||{},d=c??(i?(0,l.G)(i):null);if(!d)return a.NextResponse.json({code:"session_not_found",message:"No session data available"},{status:404});console.log("Export parameters:",{session_id:i?"present":"missing",template:o,format:r,options:s,has_snapshot:!!c}),console.log("Building resume object...");let p=d.tailored||d.preview_sections_json,u=d.original||d.original_sections_json,m={summary:s.includeSummary&&p.summary||"",skills:s.includeSkills&&p.skills_section||[],experience:(p.experience||[]).filter(e=>e.company&&e.role),education:u?.education||[],certifications:u?.certifications||[]};console.log("Resume object built"),console.log("Rendering HTML...");let g=await f(m,o,{includeSkills:!!s.includeSkills,includeSummary:!!s.includeSummary});if(console.log("HTML rendered successfully"),"pdf"===r){console.log("Generating PDF..."),console.log("HTML length:",g.length);try{let e=Date.now(),t=await y(g);if(console.log("PDF generated successfully, size:",t.length),!t||0===t.length)throw Error("PDF generation returned empty buffer");let i=Date.now()-e;(0,S.zJ)(1,!0,void 0,"external_service",t.length),(0,S.Jf)({req_id:n.id,route:"export",timing:Date.now()-n.startTime,pdf_launch_ms:i,pdf_render_ms:i,final_status:"success",was_snapshot_used:!!c,additional_metrics:{format:"pdf",template:o,html_length:g.length,pdf_size:t.length}}),n.end(!0,{size:t.length,pdf_ms:i});let r=t.buffer.slice(t.byteOffset,t.byteOffset+t.byteLength);return new a.NextResponse(r,{headers:{"Content-Type":"application/pdf","Content-Disposition":'attachment; filename="resume.pdf"',"Content-Length":String(t.length)}})}catch(e){console.error("PDF generation failed:",e),console.error("PDF error stack:",e instanceof Error?e.stack:"No stack trace"),(0,S.zJ)(1,!1,String(e),"external_service"),(0,S.H)(e,{format:r,template:o,session_id:i,htmlLength:g.length}),n.end(!1,{error:String(e)});try{let e=Date.now(),t=await h(g),i=Date.now()-e;(0,S.zJ)(1,!0,void 0,"docx_fallback",t.length),(0,S.Jf)({req_id:n.id,route:"export",timing:Date.now()-n.startTime,docx_ms:i,final_status:"success",was_snapshot_used:!!c,additional_metrics:{format:"docx_fallback",template:o,html_length:g.length,docx_size:t.length,pdf_failed:!0}}),n.end(!0,{size:t.length,fallback:"docx",docx_ms:i});let r=t.buffer.slice(t.byteOffset,t.byteOffset+t.byteLength);return new a.NextResponse(r,{headers:{"Content-Type":"application/vnd.openxmlformats-officedocument.wordprocessingml.document","Content-Disposition":'attachment; filename="resume.docx"',"Content-Length":String(t.length)}})}catch(e){return console.error("DOCX fallback failed:",e),a.NextResponse.json({code:"pdf_generation_failed",message:"Failed to generate PDF file",details:void 0},{status:500})}}}else{console.log("Generating DOCX...");try{let e=Date.now(),t=await h(g);console.log("DOCX generated successfully, size:",t.length);let i=Date.now()-e;(0,S.Jf)({req_id:n.id,route:"export",timing:Date.now()-n.startTime,docx_ms:i,final_status:"success",was_snapshot_used:!!c,additional_metrics:{format:"docx",template:o,html_length:g.length,docx_size:t.length}}),n.end(!0,{size:t.length,docx_ms:i});let r=t.buffer.slice(t.byteOffset,t.byteOffset+t.byteLength);return new a.NextResponse(r,{headers:{"Content-Type":"application/vnd.openxmlformats-officedocument.wordprocessingml.document","Content-Disposition":'attachment; filename="resume.docx"',"Content-Length":String(t.length)}})}catch(e){return console.error("DOCX generation failed:",e),n.end(!1,{error:String(e)}),a.NextResponse.json({code:"docx_generation_failed",message:"Failed to generate DOCX file",details:void 0},{status:500})}}}catch(e){console.error("Export API error:",e),console.error("Error stack:",e instanceof Error?e.stack:"No stack trace"),(0,S.H)(e,{route:"export",session_id:t||"unknown",format:n||"unknown",template:"minimal"});try{return a.NextResponse.json({code:"server_error",message:"An unexpected error occurred during export",details:void 0,timestamp:new Date().toISOString()},{status:500})}catch(e){return console.error("Failed to create JSON response:",e),a.NextResponse.json({code:"server_error",message:"An unexpected error occurred"},{status:500})}}}let P=new o.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/export/route",pathname:"/api/export",filename:"route",bundlePath:"app/api/export/route"},resolvedPagePath:"/Users/yassinkhalil/Downloads/ai-resume-tailor_v2_full/app/api/export/route.ts",nextConfigOutput:"",userland:i}),{requestAsyncStorage:F,staticGenerationAsyncStorage:E,serverHooks:O}=P,R="/api/export/route";function N(){return(0,s.patchFetch)({serverHooks:O,staticGenerationAsyncStorage:E})}},74068:(e,t,n)=>{n.d(t,{iE:()=>a,rF:()=>l});var i=n(57147),o=n.n(i);let r="/tmp/ai-resume-tailor-config.json",s={rate:{ipPerMin:Number(process.env.RATE_IP_PER_MIN||30),sessionPerMin:Number(process.env.RATE_SESSION_PER_MIN||5)},invites:(process.env.INVITE_CODES||"").split(",").map(e=>e.trim()).filter(Boolean),openaiKey:void 0,pauseTailor:!1,pauseExport:!1};function a(){return s}function l(e){s={...s,...e,rate:{...s.rate,...e.rate||{}}},function(){try{o().writeFileSync(r,JSON.stringify(s,null,2))}catch{}}()}!function(){try{if(o().existsSync(r)){let e=o().readFileSync(r,"utf8"),t=JSON.parse(e);s={...s,...t}}}catch{}}()},32064:(e,t,n)=>{n.d(t,{M9:()=>p,d7:()=>u});var i=n(87070),o=n(74068);let r=new Map,s=new Map;function a(){return Date.now()}function l(e,t){let n=a();for(;e.length&&n-e[0]>t;)e.shift()}function c(e,t){let n=e.get(t)||[];return n.push(a()),e.set(t,n),n}function d(e,t){let n=(e.headers.get("cookie")||"").match(RegExp("(?:^|; )"+t+"=([^;]+)"));return n?decodeURIComponent(n[1]):null}function p(e){return d(e,"sid")||"anon"}function u(e){let t=(0,o.iE)();if(!function(e){let t=(0,o.iE)();if(!t.invites.length)return!0;let n=e.headers.get("x-invite-code")||"",i=d(e,"invite")||"",r=n||i;return!!r&&t.invites.includes(r)}(e))return{ok:!1,res:i.NextResponse.json({code:"invite_required",message:"Invite code required"},{status:403})};let n=(e.headers.get("x-forwarded-for")||"").split(",")[0].trim()||"0.0.0.0",u=p(e),m=c(r,n),g=c(s,u);return(l(m,6e4),l(g,6e4),function(e=6e4,t=5e3){let n=a();for(let[t,i]of r){for(;i.length&&n-i[0]>e;)i.shift();0===i.length&&r.delete(t)}for(let[t,i]of s){for(;i.length&&n-i[0]>e;)i.shift();0===i.length&&s.delete(t)}if(r.size>t){for(let e of r.keys())if(r.delete(e),r.size<=t)break}if(s.size>t){for(let e of s.keys())if(s.delete(e),s.size<=t)break}}(),m.length>t.rate.ipPerMin||g.length>t.rate.sessionPerMin)?{ok:!1,res:i.NextResponse.json({code:"rate_limited",message:"Too many requests"},{status:429})}:{ok:!0}}},45647:(e,t,n)=>{n.d(t,{G:()=>a,e:()=>s});var i=n(9576);let o=new Map;function r(e=36e5){let t=Date.now();for(let[n,i]of o)t-i.createdAt>e&&o.delete(n)}function s(e,t,n,s){r();let a=(0,i.Z)(),l={id:a,createdAt:Date.now(),original:e,tailored:t,jdText:n,keywordStats:s};return o.set(a,l),l}function a(e){r();let t=o.get(e);return t?Date.now()-t.createdAt>36e5?(o.delete(e),null):t:null}},57033:(e,t,n)=>{n.d(t,{H:()=>p,Jf:()=>g,Ud:()=>d,db:()=>c,dl:()=>m,zJ:()=>u});var i=n(57147),o=n.n(i),r=n(9576);let s="/tmp/telemetry.jsonl",a=process.env.LOG_DRAIN_URL||"",l=process.env.LOG_DRAIN_KEY||"";function c(e={}){let t=(0,r.Z)(),n=Date.now();return{id:t,end:function(i,r={}){let a={req_id:t,route:e.route||"unknown",timing:Date.now()-n,timestamp:new Date().toISOString(),final_status:i?"success":"error",...e,...r};try{o().appendFileSync(s,JSON.stringify(a)+"\n")}catch(e){console.warn("Failed to write telemetry:",e)}return f(a),a}}}function d(e,t,n,i,r){let s={timestamp:new Date().toISOString(),type:"ai_response",attempt:e,success:t,error:n?.substring(0,500),responseLength:i,model:r||process.env.OPENAI_MODEL||"gpt-4o-mini"};try{o().appendFileSync("/tmp/ai-responses.jsonl",JSON.stringify(s)+"\n")}catch(e){console.warn("Failed to log AI response:",e)}f(s)}function p(e,t={}){let n={timestamp:new Date().toISOString(),type:"error",message:e.message,stack:e.stack,context:JSON.stringify(t)};try{o().appendFileSync("/tmp/error-log.jsonl",JSON.stringify(n)+"\n")}catch(e){console.warn("Failed to log error:",e)}f(n)}function u(e,t,n,i,r){let a={timestamp:new Date().toISOString(),type:"pdf_generation",attempt:e,success:t,error:n?.substring(0,500),method:i,size:r};try{o().appendFileSync(s,JSON.stringify(a)+"\n")}catch(e){console.warn("Failed to log PDF generation:",e)}f(a)}function m(e,t,n={}){let i={timestamp:new Date().toISOString(),type:"session_activity",sessionId:e,activity:t,details:JSON.stringify(n)};try{o().appendFileSync(s,JSON.stringify(i)+"\n")}catch(e){console.warn("Failed to log session activity:",e)}f(i)}function g(e){let t={timestamp:new Date().toISOString(),type:"request_telemetry",...e};try{o().appendFileSync(s,JSON.stringify(t)+"\n")}catch(e){console.warn("Failed to log request telemetry:",e)}f(t)}async function f(e){if(a)try{await fetch(a,{method:"POST",headers:{"Content-Type":"application/json",...l?{Authorization:`Bearer ${l}`}:{}},body:JSON.stringify(e)})}catch{}}},9576:(e,t,n)=>{n.d(t,{Z:()=>c});var i=n(6113),o=n.n(i);let r={randomUUID:o().randomUUID},s=new Uint8Array(256),a=s.length,l=[];for(let e=0;e<256;++e)l.push((e+256).toString(16).slice(1));let c=function(e,t,n){if(r.randomUUID&&!t&&!e)return r.randomUUID();let i=(e=e||{}).random||(e.rng||function(){return a>s.length-16&&(o().randomFillSync(s),a=0),s.slice(a,a+=16)})();if(i[6]=15&i[6]|64,i[8]=63&i[8]|128,t){n=n||0;for(let e=0;e<16;++e)t[n+e]=i[e];return t}return function(e,t=0){return l[e[t+0]]+l[e[t+1]]+l[e[t+2]]+l[e[t+3]]+"-"+l[e[t+4]]+l[e[t+5]]+"-"+l[e[t+6]]+l[e[t+7]]+"-"+l[e[t+8]]+l[e[t+9]]+"-"+l[e[t+10]]+l[e[t+11]]+l[e[t+12]]+l[e[t+13]]+l[e[t+14]]+l[e[t+15]]}(i)}}};var t=require("../../../webpack-runtime.js");t.C(e);var n=e=>t(t.s=e),i=t.X(0,[948,972],()=>n(87565));module.exports=i})();